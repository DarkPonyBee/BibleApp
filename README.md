...
Simple React Native Mobile Application for Bible Readers.

Tech stack : React Native + Redux + Redux Saga + Redux Persisit + ReactNavigation v6 + TypeScript
...
- Used Redux, Redux Saga and Redux Persist for state management.
- Screen navigation with React Navigation v6.
